...
#print(quadratic_roots_default(b=2, c=-3) == quadratic_roots_default(??)) #??
#print(quadratic_roots_default(b=4) == quadratic_roots_default(??))
...
#1, x2 = quadratic_roots_default(2, c=-3)
#x3, x4= quadratic_roots_default(??)
